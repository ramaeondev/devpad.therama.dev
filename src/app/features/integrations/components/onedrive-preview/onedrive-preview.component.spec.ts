...
describe('OneDrivePreviewComponent', () => {
  it('shows fallback when no webUrl', async () => {
    await TestBed.configureTestingModule({ imports: [OneDrivePreviewComponent] }).compileComponents();
  ...
  it('embeds when webUrl provided', async () => {
    ...
    const fixture = TestBed.createComponent(OneDrivePreviewComponent);
    const comp = fixture.componentInstance;
    comp.file = { name: 'file.pdf', size: 10, webUrl: 'https://onedrive.example.com/view.aspx' } as any;
    fixture.detectChanges();
  ...
  it('calls sanitizer with embed url when webUrl contains view.aspx', async () => {
    ...
    const fixture = TestBed.createComponent(OneDrivePreviewComponent);
    const comp = fixture.componentInstance;
    comp.file = { name: 'file.docx', size: 1, webUrl: 'https://onedrive.example.com/path/view.aspx?id=123' } as any;
