...
describe('PublicNoteComponent', () => {
  ...
  it('importToMyNotes navigates to signup if unauthenticated', async () => {
    await TestBed.configureTestingModule({ providers: [PublicNoteComponent, { provide: (await import('../../../../core/services/auth-state.service')).AuthStateService, useClass: MockAuthState }, { provide: (await import('@angular/router')).Router, useValue: { navigate: jest.fn() } }, { provide: (await import('@angular/router')).ActivatedRoute, useValue: { snapshot: { paramMap: { get: (k: string) => 'token123' }, queryParamMap: { get: (_: string) => null } } } } ] }).compileComponents();

    const fixture = TestBed.createComponent(PublicNoteComponent);
    const comp = fixture.componentInstance;

    (TestBed.inject((await import('../../../../core/services/auth-state.service')).AuthStateService) as any).isAuthenticated.mockReturnValue(false);
    await comp.importToMyNotes();

    expect(TestBed.inject((await import('@angular/router')).Router as any).navigate).toHaveBeenCalledWith(['/auth/signup']);
  });
  ...
  it('importToMyNotes forks and opens when authenticated and readonly', async () => {
    ...
    (TestBed.inject((await import('../../../../core/services/auth-state.service')).AuthStateService) as any).userId.mockReturnValue('u2');
    comp.share.set({ share_token: 't', permission: 'readonly' } as any);
  ...
  it('saveContent shows error when updatePublicContent fails', async () => {
    ...
    await TestBed.configureTestingModule({ providers: [PublicNoteComponent, { provide: (await import('../../../../core/services/share.service')).ShareService, useValue: mockShareSvc }, { provide: (await import('../../../../core/services/auth-state.service')).AuthStateService, useClass: MockAuthState }, { provide: (await import('../../../../core/services/toast.service')).ToastService, useValue: mockToast }, { provide: (await import('@angular/router')).ActivatedRoute, useValue: { snapshot: { paramMap: { get: (k: string) => 'token123' }, queryParamMap: { get: (_: string) => null } } } } ] }).compileComponents();
  ...
  it('openInDashboard shows toast error when ensurePublicFolder fails', async () => {
    ...
    await TestBed.configureTestingModule({ providers: [PublicNoteComponent, { provide: (await import('../../../../core/services/share.service')).ShareService, useValue: failingShare }, { provide: (await import('../../../../core/services/auth-state.service')).AuthStateService, useClass: MockAuthState }, { provide: (await import('../../../../core/services/toast.service')).ToastService, useValue: mockToast }, { provide: (await import('@angular/router')).ActivatedRoute, useValue: { snapshot: { paramMap: { get: (k: string) => 'token123' }, queryParamMap: { get: (_: string) => null } } } } ] }).compileComponents();
  ...
  it('handleImportAndOpen returns error for editable shares when user is not owner', async () => {
    ...
    await TestBed.configureTestingModule({ providers: [PublicNoteComponent, { provide: (await import('../../../../core/services/share.service')).ShareService, useValue: svc }, { provide: (await import('../../../../core/services/auth-state.service')).AuthStateService, useClass: MockAuthState }, { provide: (await import('../../../../core/services/toast.service')).ToastService, useValue: mockToast }, { provide: (await import('@angular/router')).ActivatedRoute, useValue: { snapshot: { paramMap: { get: (k: string) => 'token123' }, queryParamMap: { get: (_: string) => null } } } } ] }).compileComponents();
    ...
    await (comp as any).handleImportAndOpen({ share_token: 't', permission: 'editable', user_id: 'owner1' } as any);
    expect(mockToast.error).toHaveBeenCalled();
  ...
  it('handleDashboardRedirect navigates for owner/editable shares', async () => {
    ...
    await TestBed.configureTestingModule({ providers: [PublicNoteComponent, { provide: (await import('../../../../core/services/auth-state.service')).AuthStateService, useValue: mockAuth }, { provide: (await import('../../../../core/services/share.service')).ShareService, useValue: mockShareSvc }, { provide: (await import('@angular/router')).Router, useValue: mockRouter }, { provide: (await import('@angular/router')).ActivatedRoute, useValue: { snapshot: { paramMap: { get: (k: string) => 'token123' }, queryParamMap: { get: (_: string) => null } } } } ] }).compileComponents();
  ...
  it('handleImportAndOpen calls handleDashboardRedirect when user is owner', async () => {
    ...
    await TestBed.configureTestingModule({ providers: [PublicNoteComponent, { provide: (await import('../../../../core/services/auth-state.service')).AuthStateService, useValue: mockAuth }, { provide: (await import('@angular/router')).ActivatedRoute, useValue: { snapshot: { paramMap: { get: (k: string) => 'token123' }, queryParamMap: { get: (_: string) => null } } } } ] }).compileComponents();

    const fixture = TestBed.createComponent(PublicNoteComponent);
    const comp = fixture.componentInstance;

    const spy = jest.spyOn(comp as any, 'handleDashboardRedirect').mockImplementation(async () => {});
  ...
  it('ngOnDestroy removes visibility listener', async () => {
    await TestBed.configureTestingModule({ providers: [PublicNoteComponent, { provide: (await import('../../../../core/services/share.service')).ShareService, useClass: MockShare }, { provide: (await import('@angular/router')).ActivatedRoute, useValue: { snapshot: { paramMap: { get: (k: string) => 'token123' }, queryParamMap: { get: (_: string) => null } } } } ] }).compileComponents();
  ...
  it('startPolling logs errors when refresh fails', async () => {
    jest.useFakeTimers();
    const mockShareSvc: any = { getShareContentForRefresh: jest.fn().mockRejectedValue(new Error('refresh fail')) };

    await TestBed.configureTestingModule({ providers: [PublicNoteComponent, { provide: (await import('../../../../core/services/share.service')).ShareService, useValue: mockShareSvc }, { provide: (await import('@angular/router')).ActivatedRoute, useValue: { snapshot: { paramMap: { get: (k: string) => 'token123' }, queryParamMap: { get: (_: string) => null } } } } ] }).compileComponents();
  ...
  it('handleDashboardRedirect shows error on failure and clears processing flag', async () => {
    ...
    const mockAuth: any = { userId: () => 'u1', isAuthenticated: jest.fn().mockReturnValue(true) };
    const mockShareSvc: any = { ensurePublicFolder: jest.fn().mockRejectedValue(new Error('fail')) };
    const mockToast: any = { error: jest.fn(), success: jest.fn() };

    await TestBed.configureTestingModule({ providers: [PublicNoteComponent, { provide: (await import('../../../../core/services/auth-state.service')).AuthStateService, useValue: mockAuth }, { provide: (await import('../../../../core/services/share.service')).ShareService, useValue: mockShareSvc }, { provide: (await import('../../../../core/services/toast.service')).ToastService, useValue: mockToast }, { provide: (await import('@angular/router')).ActivatedRoute, useValue: { snapshot: { paramMap: { get: (k: string) => 'token123' }, queryParamMap: { get: (_: string) => null } } } } ] }).compileComponents();
  ...
  it('handleImportAndOpen success shows info and success toasts and navigates', async () => {
    ...
    const mockAuth: any = { userId: () => 'u1', isAuthenticated: jest.fn().mockReturnValue(true) };
    const mockShareSvc: any = { importPublicShare: jest.fn().mockResolvedValue({ note_id: 'nNew' }), ensurePublicFolder: jest.fn().mockResolvedValue({ id: 'pf' }) };
    const mockRouter: any = { navigate: jest.fn() };
    const mockToast: any = { info: jest.fn(), success: jest.fn(), error: jest.fn() };

    await TestBed.configureTestingModule({ providers: [PublicNoteComponent, { provide: (await import('../../../../core/services/share.service')).ShareService, useValue: mockShareSvc }, { provide: (await import('../../../../core/services/auth-state.service')).AuthStateService, useValue: mockAuth }, { provide: (await import('@angular/router')).Router, useValue: mockRouter }, { provide: (await import('../../../../core/services/toast.service')).ToastService, useValue: mockToast }, { provide: (await import('@angular/router')).ActivatedRoute, useValue: { snapshot: { paramMap: { get: (k: string) => 'token123' }, queryParamMap: { get: (_: string) => null } } } } ] }).compileComponents();
  ...
  it('saveContent for non-owner editor shows saved toast and does not navigate', async () => {
    const mockShareSvc: any = { updatePublicContent: jest.fn().mockResolvedValue({}), ensurePublicFolder: jest.fn() };
    ...
    await TestBed.configureTestingModule({ providers: [PublicNoteComponent, { provide: (await import('../../../../core/services/share.service')).ShareService, useValue: mockShareSvc }, { provide: (await import('../../../../core/services/auth-state.service')).AuthStateService, useValue: mockAuth }, { provide: (await import('../../../../core/services/toast.service')).ToastService, useValue: mockToast }, { provide: (await import('@angular/router')).ActivatedRoute, useValue: { snapshot: { paramMap: { get: (k: string) => 'token123' }, queryParamMap: { get: (_: string) => null } } } } ] }).compileComponents();
