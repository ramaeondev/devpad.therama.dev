...
describe('SignupComponent', () => {
  ...
  it('onSubmit handles supabase error', async () => {
    class MockSupabaseErr { auth = { signUp: jest.fn().mockResolvedValue({ data: null, error: new Error('nope') }) }; authDirect = { signInWithOAuth: jest.fn().mockResolvedValue({}) }; }
    await TestBed.configureTestingModule({ imports: [SignupComponent, (await import('@angular/router/testing')).RouterTestingModule], providers: [{ provide: (await import('../../../../core/services/supabase.service')).SupabaseService, useClass: MockSupabaseErr }, { provide: (await import('../../../../core/services/device-fingerprint.service')).DeviceFingerprintService, useClass: MockDevice }, { provide: (await import('../../../../core/services/toast.service')).ToastService, useClass: MockToast }] }).compileComponents();

    const fixture = TestBed.createComponent(SignupComponent);
    const comp = fixture.componentInstance;

    comp.signupForm.setValue({ firstName: '', lastName: '', email: 'x@y.com', password: 'secret', confirmPassword: 'secret', termsAccepted: true });
    await comp.onSubmit();
  ...
  it('onSubmit continues when device registration fails', async () => {
    class MockDeviceFail { registerDevice = jest.fn().mockRejectedValue(new Error('fail')); }

    await TestBed.configureTestingModule({ imports: [SignupComponent, (await import('@angular/router/testing')).RouterTestingModule], providers: [{ provide: (await import('../../../../core/services/supabase.service')).SupabaseService, useClass: MockSupabase }, { provide: (await import('../../../../core/services/device-fingerprint.service')).DeviceFingerprintService, useClass: MockDeviceFail }, { provide: (await import('../../../../core/services/toast.service')).ToastService, useClass: MockToast }] }).compileComponents();
  ...
  it('signUpWithGoogle handles OAuth error', async () => {
    class MockSupOAuth { auth = { signUp: jest.fn().mockResolvedValue({ data: null, error: null }) }; authDirect = { signInWithOAuth: jest.fn().mockResolvedValue({ error: new Error('oauth fail') }) }; }

    await TestBed.configureTestingModule({ imports: [SignupComponent, (await import('@angular/router/testing')).RouterTestingModule], providers: [{ provide: (await import('../../../../core/services/supabase.service')).SupabaseService, useClass: MockSupOAuth }, { provide: (await import('../../../../core/services/toast.service')).ToastService, useClass: MockToast }] }).compileComponents();
