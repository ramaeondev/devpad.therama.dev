...
@Component({
  ...
  template: `
    <div class="min-h-screen grid lg:grid-cols-2">
      ...
      <div
        class="hidden lg:flex flex-col justify-center p-12 bg-gray-50 dark:bg-gray-900 relative overflow-hidden"
      >
        <!-- Background Decoration -->
        <div class="absolute inset-0 z-0">
          <div
            class="absolute -top-[20%] -right-[10%] w-[60%] h-[60%] rounded-full bg-primary-200/30 blur-3xl dark:bg-primary-900/10"
          ></div>
          <div
            class="absolute bottom-[10%] -left-[10%] w-[50%] h-[50%] rounded-full bg-blue-200/30 blur-3xl dark:bg-blue-900/10"
          ></div>
        </div>
        ...
        <div class="relative z-10 max-w-lg mx-auto w-full space-y-8">
          ...
          <div class="grid grid-cols-2 gap-4 auto-rows-[140px]">
            <!-- Tile 1: Encryption -->
            <div
              class="col-span-2 row-span-1 rounded-3xl bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl border border-white/20 dark:border-gray-700/50 p-6 flex flex-col justify-center shadow-sm"
            >
              <div class="flex items-center gap-4">
                <div
                  class="h-10 w-10 rounded-xl bg-green-100 text-green-600 dark:bg-green-900/30 dark:text-green-400 flex items-center justify-center"
                >
            ...
            <!-- Tile 2: Cloud -->
            <div
              class="row-span-1 rounded-3xl bg-white/60 dark:bg-gray-800/60 backdrop-blur-xl border border-white/20 dark:border-gray-700/50 p-6 flex flex-col justify-between shadow-sm"
            >
              <div
                class="h-10 w-10 rounded-xl bg-orange-100 text-orange-600 dark:bg-orange-900/30 dark:text-orange-400 flex items-center justify-center"
              >
            ...
            >
              <div
                class="h-10 w-10 rounded-xl bg-gray-100 text-gray-900 dark:bg-gray-700 dark:text-gray-100 flex items-center justify-center"
              >
            ...
            >
              <div
                class="h-10 w-10 rounded-xl bg-violet-100 text-violet-600 dark:bg-violet-900/30 dark:text-violet-400 flex items-center justify-center"
              >
      ...
      <div class="flex items-center justify-center p-4 sm:p-12 bg-white dark:bg-gray-950">
        <div class="max-w-md w-full space-y-8">
          ...
          <form class="mt-8 space-y-6" [formGroup]="signupForm" (ngSubmit)="onSubmit()">
            ...
            @if (
              signupForm.get('termsAccepted')?.touched && signupForm.get('termsAccepted')?.invalid
            ) {
              <div
                class="rounded-lg bg-red-50 dark:bg-red-900/20 p-4 border border-red-200 dark:border-red-800"
              >
