      ...
      <div class="max-w-md w-full space-y-6 sm:space-y-8">
        ...
        <div class="mt-6 sm:mt-8">
          <button
            ...
            [disabled]="loading()"
            class="w-full flex justify-center items-center gap-3 px-4 py-3 border border-gray-300 dark:border-gray-600 shadow-sm text-sm font-medium rounded-md text-gray-700 dark:text-gray-200 bg-white dark:bg-gray-800 hover:bg-gray-50 dark:hover:bg-gray-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary-500 transition-colors"
          >
        ...
        <form
          class="mt-6 space-y-5 sm:space-y-6"
