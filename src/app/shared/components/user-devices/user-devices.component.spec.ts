...
describe('UserDevicesComponent', () => {
  ...
  it('loadDevices sets devices and shows actions', async () => {
    const devices = [{ id: 'd1', device_name: 'MyPhone', is_trusted: false, is_current: false, browser_name: 'Chrome', os_name: 'iOS', last_seen_at: new Date().toISOString(), city: 'NY', country: 'US' }];
    const mock: any = { getUserDevices: jest.fn().mockResolvedValue(devices), updateDeviceName: jest.fn().mockResolvedValue(true), trustDevice: jest.fn().mockResolvedValue(true), removeDevice: jest.fn().mockResolvedValue(true) };

    await TestBed.configureTestingModule({ imports: [UserDevicesComponent], providers: [ { provide: (await import('../../../core/services/device-fingerprint.service')).DeviceFingerprintService, useValue: mock }, { provide: (await import('../../../core/services/auth-state.service')).AuthStateService, useClass: MockAuthState }, { provide: (await import('../../../core/services/toast.service')).ToastService, useClass: MockToast } ] }).compileComponents();
  ...
  it('loadDevices handles error and shows toast', async () => {
    ...
    await TestBed.configureTestingModule({ imports: [UserDevicesComponent], providers: [ { provide: (await import('../../../core/services/device-fingerprint.service')).DeviceFingerprintService, useValue: mock }, { provide: (await import('../../../core/services/auth-state.service')).AuthStateService, useClass: MockAuthState }, { provide: (await import('../../../core/services/toast.service')).ToastService, useValue: toast } ] }).compileComponents();
  ...
  it('saveDeviceName success path updates and reloads', async () => {
    const mock: any = { updateDeviceName: jest.fn().mockResolvedValue(true), getUserDevices: jest.fn().mockResolvedValue([]) };
    const toast = { success: jest.fn(), error: jest.fn() };
  ...
  it('saveDeviceName failure shows toast', async () => {
    ...
    await TestBed.configureTestingModule({ imports: [UserDevicesComponent], providers: [ { provide: (await import('../../../core/services/device-fingerprint.service')).DeviceFingerprintService, useValue: mockFalse }, { provide: (await import('../../../core/services/auth-state.service')).AuthStateService, useClass: MockAuthState }, { provide: (await import('../../../core/services/toast.service')).ToastService, useValue: toast1 } ] }).compileComponents();
  ...
  it('saveDeviceName exception shows toast', async () => {
    ...
    TestBed.resetTestingModule();
    await TestBed.configureTestingModule({ imports: [UserDevicesComponent], providers: [ { provide: (await import('../../../core/services/device-fingerprint.service')).DeviceFingerprintService, useValue: mockErr }, { provide: (await import('../../../core/services/auth-state.service')).AuthStateService, useClass: MockAuthState }, { provide: (await import('../../../core/services/toast.service')).ToastService, useValue: toast2 } ] }).compileComponents();
  ...
  it('trustDevice success shows toast and reloads', async () => {
    const mockOK: any = { trustDevice: jest.fn().mockResolvedValue(true), getUserDevices: jest.fn().mockResolvedValue([]) };
    const toastOK = { success: jest.fn(), error: jest.fn() };

    TestBed.resetTestingModule();
    await TestBed.configureTestingModule({ imports: [UserDevicesComponent], providers: [ { provide: (await import('../../../core/services/device-fingerprint.service')).DeviceFingerprintService, useValue: mockOK }, { provide: (await import('../../../core/services/auth-state.service')).AuthStateService, useClass: MockAuthState }, { provide: (await import('../../../core/services/toast.service')).ToastService, useValue: toastOK } ] }).compileComponents();
  ...
  it('trustDevice failure shows error toast', async () => {
    ...
    TestBed.resetTestingModule();
    await TestBed.configureTestingModule({ imports: [UserDevicesComponent], providers: [ { provide: (await import('../../../core/services/device-fingerprint.service')).DeviceFingerprintService, useValue: mockFail }, { provide: (await import('../../../core/services/auth-state.service')).AuthStateService, useClass: MockAuthState }, { provide: (await import('../../../core/services/toast.service')).ToastService, useValue: toastFail } ] }).compileComponents();
  ...
  it('trustDevice exception shows error toast', async () => {
    ...
    TestBed.resetTestingModule();
    await TestBed.configureTestingModule({ imports: [UserDevicesComponent], providers: [ { provide: (await import('../../../core/services/device-fingerprint.service')).DeviceFingerprintService, useValue: mockErr }, { provide: (await import('../../../core/services/auth-state.service')).AuthStateService, useClass: MockAuthState }, { provide: (await import('../../../core/services/toast.service')).ToastService, useValue: toastErr } ] }).compileComponents();
  ...
  it('removeDevice sets confirm flags and onRemoveConfirm flows', async () => {
    const mock: any = { removeDevice: jest.fn().mockResolvedValue(true), getUserDevices: jest.fn().mockResolvedValue([]) };
    const toast = { success: jest.fn(), error: jest.fn() };
  ...
  it('formatDate handles multiple ranges', async () => {
    ...
    expect(comp.formatDate(new Date(Date.now() - 5 * 60 * 1000).toISOString())).toContain('5 minute');
    expect(comp.formatDate(new Date(Date.now() - 2 * 3600 * 1000).toISOString())).toContain('2 hour');
    expect(comp.formatDate(new Date(Date.now() - 3 * 24 * 3600 * 1000).toISOString())).toContain('3 day');
