            ...
            >
              ...
              @if (t.type === 'info') {
                <svg class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor">
                  <path
                    fill-rule="evenodd"
                    d="M18 10A8 8 0 11-2 10a8 8 0 0120 0zM9 9a1 1 0 112 0v6a1 1 0 11-2 0V9zm1-4a1.5 1.5 0 100 3 1.5 1.5 0 000-3z"
                    clip-rule="evenodd"
                  />
                </svg>
              }
              @if (t.type === 'warning') {
                <svg class="h-3.5 w-3.5" viewBox="0 0 20 20" fill="currentColor">
                  <path
                    d="M8.257 3.099c.765-1.36 2.721-1.36 3.486 0l6.518 11.58c.75 1.334-.213 2.996-1.743 2.996H3.482c-1.53 0-2.493-1.662-1.743-2.996L8.257 3.1z"
                  />
                  <path
                    d="M11 13a1 1 0 10-2 0 1 1 0 002 0zM10 7a1 1 0 00-1 1v2a1 1 0 102 0V8a1 1 0 00-1-1z"
                  />
                </svg>
              }
            </span>
