...
export const routes: Routes = [
  ...
  },
  {
    path: 'changelog',
    loadChildren: () =>
      import('./features/home/pages/changelog/changelog.routes').then((m) => m.changelogRoutes),
  },
  {
    path: 'auth',
  ...
  },
  {
    ...
    loadComponent: () =>
      import('./features/notes/pages/public-note/public-note.component').then(
        (m) => m.PublicNoteComponent,
      ),
