...
const envVariables = {
  ...
  BETTERSTACK_LOGS_INGEST_KEY: process.env.BETTERSTACK_LOGS_INGEST_KEY || '',
  BETTERSTACK_LOGS_INGEST_URL: process.env.BETTERSTACK_LOGS_INGEST_URL || '',
  BETTERSTACK_CLIENT_FORWARD_URL: process.env.BETTERSTACK_CLIENT_FORWARD_URL || '',
  BETTERSTACK_RUM_KEY: process.env.BETTERSTACK_RUM_KEY || '',
  BETTERSTACK_SERVICE_NAME: process.env.BETTERSTACK_SERVICE_NAME || ''
}
...
const generateConfigFile = (filePath) => {
  ...
  BETTERSTACK_LOGS_INGEST_KEY: '${envVariables.BETTERSTACK_LOGS_INGEST_KEY}',
  BETTERSTACK_LOGS_INGEST_URL: '${envVariables.BETTERSTACK_LOGS_INGEST_URL}',
  BETTERSTACK_CLIENT_FORWARD_URL: '${envVariables.BETTERSTACK_CLIENT_FORWARD_URL}',
  BETTERSTACK_RUM_KEY: '${envVariables.BETTERSTACK_RUM_KEY}',
  BETTERSTACK_SERVICE_NAME: '${envVariables.BETTERSTACK_SERVICE_NAME}',
};
`
